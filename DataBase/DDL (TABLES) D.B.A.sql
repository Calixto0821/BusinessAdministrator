...
debt DECIMAL(10,2) NULL DEFAULT 0,
status INT NOT NULL DEFAULT 1
);
...
price_purchase DECIMAL(10,2) NOT NULL, --PURCHASE UNITY
sub_total DECIMAL(10,2) NOT NULL --(Product quantity*Price purchase)
);
...
cash_recieved DECIMAL(10,2) NOT NULL,
